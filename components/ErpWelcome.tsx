...
const CONTENT = {
  deepnight: {
    eyebrow: "DEEPNIGHT ENTERPRISE INFORMATION PORTAL",
    company: "深夜不關燈陪玩",
    hint: "今晚的營運、訂單與團隊管理，都從這裡開始。",
  },
  qiunai: {
    eyebrow: "QIUNAI ESPORTS ENTERPRISE INFORMATION PORTAL",
    company: "秋奈電競陪玩",
...
export default function ErpWelcome({
  ...
  return (
    <main
      ...
      aria-label={`歡迎使用 ${content.company} EIP`}
    >
