...
create table if not exists public.erp_role_assignments (
  ...
  discord_id text not null, display_name text, role text not null default 'employee' check (role in ('super_admin', 'store_manager', 'customer_service', 'audit_reviewer', 'employee')),
